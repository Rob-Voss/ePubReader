var Paginator = function (fromNode, toNode, styleContent) {
  ...
  var realHeight = document.defaultView.getComputedStyle(toNode, null).getPropertyValue('height').replace('px', '');
  ...
  var nodeHandler = new function () {
    ...
    this.startElement = function (element, c) {
      ...
      if (newNode.nodeName === 'IMG' || newNode.nodeName === 'image') {
        ...
        var containerWidth = document.defaultView.getComputedStyle(currentNode, null).getPropertyValue('width').replace('px', '');
